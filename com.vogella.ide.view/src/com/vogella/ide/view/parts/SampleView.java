package com.vogella.ide.view.parts;
...
public class SampleView {
	...
	public void createPartControl(Composite parent) {
		...
		myButton = new Button(parent, 0);
		myButton.setText("Choose options");
		
		// button manage classes -> all classes as workspace Tree -> check boxes
		// in view will be diagram from checked classes
		// or Selection listener of Project Explorer?
	}
	...
	public void setSelection(@Named(IServiceConstants.ACTIVE_SELECTION) Object o) {
		...
		/*
		 * Remove the 2 following lines in pure E4 mode, keep them in mixed mode if (o instanceof ISelection) // Already captured return;
		 */
